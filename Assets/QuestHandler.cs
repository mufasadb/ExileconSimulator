...
public class QuestHandler : MonoBehaviour
{
    ...
    {
        CheckIndividualTierReceiving(questTier1ReadyToReceive, 1);
        CheckIndividualTierReceiving(questTier2ReadyToReceive, 2);
        CheckIndividualTierReceiving(questTier3ReadyToReceive, 3);
        CheckIndividualTierReceiving(questTier4ReadyToReceive, 4);
    }
